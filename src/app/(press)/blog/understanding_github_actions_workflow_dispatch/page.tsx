...
export async function generateMetadata() {
  return generatePageMetadata({
    ...
    canonicalUrl:"/blog/understanding_github_actions_workflow_dispatch",
    type: "article",
  });
}
       ...
       dangerouslySetInnerHTML={{
         __html: JSON.stringify(
           buildBreadcrumbJsonLd([
             ...
             { name: "GitHub Actions Workflow Dispatch", url: getAbsoluteUrl("/blog/understanding_github_actions_workflow_dispatch") },
           ])
         ),
       }}
     />
       ...
       dangerouslySetInnerHTML={{
         __html: JSON.stringify(
           buildArticleJsonLd({
             ...
             canonicalUrl: getAbsoluteUrl("/blog/understanding_github_actions_workflow_dispatch"),
           })
         ),
       }}
     />

       ...
       dangerouslySetInnerHTML={{
         __html: JSON.stringify(
           buildBreadcrumbJsonLd([
             ...
             { name: "Prisma Self Relations", url: getAbsoluteUrl("/blog/prisma-self-relations") },
           ])
         ),
       }}
     />
       ...
       dangerouslySetInnerHTML={{
         __html: JSON.stringify(
           buildArticleJsonLd({
             title: "Prisma Self Relations",
             description:
               "Learn how to manage self-relations in Prisma with clear examples and practical code snippets. Explore 1:1, 1:M, and M:M self-relations, including schema definitions and queries for user-manager, category-subcategory, and person-friend models. Ideal for understanding Prisma's approach to self-referencing relationships in your database schema.",
             canonicalUrl: getAbsoluteUrl("/blog/prisma-self-relations"),
           })
         ),
       }}
     />

                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <Box sx={{ p: 4, display: "flex", flexDirection: "column", justifyContent: "center", height: "100%" }}>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      <Stack direction="row" spacing={2} sx={{ color: theme.palette.text.secondary, fontSize: "0.875rem" }}>
                ...
                >
                  ...
                  <CardContent sx={{ pt: 0, mt: "auto" }}>
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 2 }}>
                      <Stack direction="row" spacing={1} sx={{ color: theme.palette.text.secondary, fontSize: "0.75rem" }}>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>

        ...
        <Grid container spacing={6}>
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            <Box sx={{ mb: 4 }}>
              ...
              >
                Empowering developers with powerful tools and insightful resources. 
                Build better, code smarter, and stay inspired.
              </Typography>
            </Box>
            ...
            <Box display="flex" gap={2}>
              {footerLinks.social.map((social) => (
                ...
                >
                  <social.icon style={{ width: 20, height: 20, color: theme.palette.text.primary }} />
                </IconButton>
              ))}
            </Box>
          </Grid>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 4 }}>
            <Typography variant="subtitle1" sx={{ fontWeight: 600, color: theme.palette.text.primary, mb: 2 }}>
              Product
            </Typography>
